...
1:2 Some events are more important that others so you categorize them by their severity. Higher severity events can be distinguished from, and handled differently to, lower severity ones.
