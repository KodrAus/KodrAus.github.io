...
For you other maintainers out there, I would definitely recommend looking into some kind of similar CI setup for your projects too. If you've never tried fuzzing before, there's [a `rust-fuzz` book](https://rust-fuzz.github.io/book/introduction.html) that guides you through the moving parts and how to use them. You'll be amazed at what you find.
